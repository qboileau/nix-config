...
Item {
    ...
    // Main.qml reads this to lift the form above the virtual keyboard, but
    // upstream never defined it (evaluated to undefined -> NaN y).
    property real visibleBoundary: mapFromItem(innerLayout, 0, innerLayout.height).y
